...
static const char qt_meta_stringdata_VlcAudio[] = {
    "VlcAudio\0"
};
...
const QMetaObjectExtraData VlcAudio::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VlcAudio::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VlcAudio,
      qt_meta_data_VlcAudio, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VlcAudio::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VlcAudio))
