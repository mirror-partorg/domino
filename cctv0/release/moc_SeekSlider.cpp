...
static const char qt_meta_stringdata_SeekSlider[] = {
    "SeekSlider\0\0sliderDragged(QDateTime)\0"
    ",,\0setPosition(float,QDateTime&,int)\0"
...
void SeekSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sliderDragged((*reinterpret_cast< QDateTime(*)>(_a[1]))); break;
        case 1: _t->setPosition((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< QDateTime(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
...
// SIGNAL 0
void SeekSlider::sliderDragged(QDateTime _t1)
{
