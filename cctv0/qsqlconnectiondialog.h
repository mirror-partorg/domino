...
public:
    ...
    static bool initSqlConnection(QSettings *settings = NULL);
    static bool sqlConnectionDialog(QSettings *settings);
    ...
    static QSqlDatabase cloneDatabase(const QString& connectionName);
