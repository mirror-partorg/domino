CC = gcc
TMP_DIR=var/Linux/CentOS/Core/x86_64
...
MAKE=make
AM_MAKEFLAGS=CC=gcc
AM_FLAGS=-L../../var/Linux/CentOS/Core/x86_64/.libs -I/usr/include/loudmouth-1.0 -I../../lib/ffmpeg -I../../include -D_LINUX -DHAVE_SYSLOG -L/usr/local/psql/lib -L/usr/local/psql/lib64 -DBTI_LINUX_64 -I../../var/Linux/CentOS/Core/x86_64\
-DDOMINO78 \
-DZLIB \
-DCUPS \
-DUSE_NCURSES \
...
PYTHON_LIBS_2=-lpython2
PYTHON_VERSION_2=2.7
PYTHON_DIR_2=/usr/lib/python2.7/site-packages
PYTHON_VERSION_3=3.4
PYTHON_CFLAGS_3=-I/usr/include/python3.4m
PYTHON_LIBS_3=-lpython3
PYTHON_VERSION_3=3.4
PYTHON_DIR_3=/usr/lib/python3.4/site-packages
