CC = gcc
LINK = g++
TMP_DIR=../../../../var/Linux/Debian/bullseye/x86_64
...
MAKE=make
AM_MAKEFLAGS=CC=gcc
AM_FLAGS=-L$(TMP_DIR)/.libs -I/usr/include/loudmouth-1.0 -I../../lib/ffmpeg -I../../include -D_LINUX -DHAVE_SYSLOG -L/usr/local/actianzen/lib64 -DBTI_LINUX_64 -I../../var/Linux/Debian/bullseye/x86_64\
-DZLIB \
-DDOMINO78 \
-DCUPS \
-DUSE_NCURSES \
...
PYTHON_VERSION_3=3.9
PYTHON_CFLAGS_3=-I/usr/include/python3.9 -I/usr/include/x86_64-linux-gnu/python3.9
PYTHON_LIBS_3=
PYTHON_VERSION_3=3.9
