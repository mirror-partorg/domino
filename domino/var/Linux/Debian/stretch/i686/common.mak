CC = gcc
TMP_DIR=var/Linux/Debian/stretch/i686
...
MAKE=make
AM_MAKEFLAGS=CC=gcc
AM_FLAGS=-L../../var/Linux/Debian/stretch/i686/.libs -I/usr/include/loudmouth-1.0 -I../../lib/ffmpeg -I../../include -D_LINUX -DHAVE_SYSLOG -L/usr/local/psql/lib -L/usr/local/psql/lib64 -DBTI_LINUX -I../../var/Linux/Debian/stretch/i686\
-DZLIB \
-DUSE_NCURSES \
-DDOMINO78 
