CC = gcc
LINK = g++
TMP_DIR=../../../../var/MINGW64_NT-10.0-19045/x86_64
...
MAKE=make
AM_MAKEFLAGS=CC=gcc
AM_FLAGS=-L$(TMP_DIR)/.libs -I/usr/include/loudmouth-1.0 -I../../lib/ffmpeg -I../../include -D_LINUX -DHAVE_SYSLOG -L/usr/local/psql/lib -L/usr/local/psql/lib64 -DBTI_LINUX_64 -I../../var/MINGW64_NT-10.0-19045/x86_64\
-DZLIB \
-L"C:/PVSW/bin64"  \
-DDOMINO78 \
-DUSE_NCURSES \
...
PYTHON_CFLAGS_3=-I/usr/include/python3.12
PYTHON_LIBS_3=-L/usr/lib -lpython3.12
PYTHON_VERSION_3=3.12
PYTHON_DIR_3=
LIBICONV=-llibiconv
