CC = z:/dev/msys64/mingw32/bin/gcc.exe
LINK= z:/dev/msys64/mingw32/bin/g++.exe
TMP_DIR=Z:/dev/msys64/home/mobile1c/work/var/MSYS_NT-10.0-19045/i686
MAKE=make
AM_MAKEFLAGS=CC=gcc
PYTHON_VERSION_3=3.4
AM_FLAGS=-m32 -DDOMINO78 \
-I../../include \
-I../../var/MSYS_NT-10.0-19045/i686 \
...
-LZ:/dev/msys64/home/mobile1c/work/var/MSYS_NT-10.0-19045/i686/.libs \
-LC:/PVSW/bin \
-DZLIB \
-DWINSOCK \
-DBINARY_UPDATE 
...
PYTHON_LIBS_3=-lpython34 -Lz:/dev/bin/Python34
