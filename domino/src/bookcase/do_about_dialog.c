...
void do_about_dialog(GtkWindow *win, gchar *comment)
{
    ...
    gchar *full_version;
    full_version = g_strdup_printf("%s от %s",VERSION, ADATE);
    gtk_show_about_dialog(win,
                           "name", g_get_application_name(),
                           //"website", website_url,
                           //"website-label", website_url,
                           "logo-icon-name", "bookcase",
                           "license", LICENSE,
                           "wrap-license", TRUE,
                           "authors", authors,
                           "translator-credits",  "translator-credits",
                           "copyright", "Права 2010-21 Ришес Юрий",
                           "comments", comment,
