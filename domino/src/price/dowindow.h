...
GtkWidget *do_window_new (GtkWindowType type,const gchar *name);

void gtk_window_load_geometry (GtkWindow *window);
void gtk_window_save_geometry (GtkWindow *window);
