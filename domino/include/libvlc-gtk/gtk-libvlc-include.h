...
void list_options_add_options (gchar*** pOptions, gchar** options);
void list_options_add_option (gchar*** pOptions, gchar* option);
void list_options_free (gchar** pOptions);
